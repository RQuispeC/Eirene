...
$conn->query($sql);
$sql2 = "select area, cantidade from (SELECT 'ciencias_humanas' as area,@var1 as cantidade UNION ALL
    SELECT 'ciencias_humanas' as area,@var2 as cantidade UNION ALL
    SELECT 'engenheria' as area,@var3 as cantidade UNION ALL
    SELECT 'ciencias_agrarias' as area,@var4 as cantidade UNION ALL
    SELECT 'ciencias_biologicas' as area,@var5 as cantidade UNION ALL
    SELECT 'linguistica_artes' as area,@var6 as cantidade UNION ALL
    SELECT 'ciencias_da_saude' as area,@var7 as cantidade UNION ALL
    SELECT 'ciencias_sociais' as area,@var8 as cantidade UNION ALL
    SELECT 'interdisciplinarias', interdisciplinarias  as cantidade FROM (
...
if ($result->num_rows > 0) {
	...
	$conn->query($sql);
        ...
        $fp = fopen('json/peopleByArea.json', 'w');
